...
GO
if not exists(select [Name] from Permissions where [Name]=N'ServiceNeeded.View')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'ServiceNeeded.Edit')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'ServiceNeeded.Delete')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Diagnosis.Edit')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Diagnosis.Delete')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Treatment.View')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Treatment.Edit')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Treatment.Delete')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Advice.View')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Advice.Edit')
begin
...
if not exists(select [Name] from Permissions where [Name]=N'Advice.Delete')
begin
